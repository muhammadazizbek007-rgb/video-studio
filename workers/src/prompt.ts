 ...
 *
 * Keep in sync with functions/src/providers/google/promptBuilder.js
 */
 ...
 */
export const CAMERA_MOTION_PROMPTS: Record<string, string> = {
...
export function describeCameraMotion(cameraMotion?: string): string | null {
...
export function describeStylePreset(stylePreset?: string): string | null {
