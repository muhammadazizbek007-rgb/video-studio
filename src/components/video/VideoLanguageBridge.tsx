...
const RU_VIDEO_COPY: Record<string, string> = {
  ...
  'Google Vertex AI Diagnostics': 'Диагностика Google Vertex AI',
  'Safe backend-only check. The API key is never shown in the browser.':
    'Безопасная backend-проверка. Учётные данные никогда не показываются в браузере.',
  'Test Vertex AI': 'Проверить Vertex AI',
  Testing: 'Проверяем...',
  'API key': 'API-ключ',
  Status: 'Статус',
  active: 'активен',
